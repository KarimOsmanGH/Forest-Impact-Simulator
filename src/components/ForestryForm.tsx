...
const ForestryForm: React.FC<ForestryFormProps> = ({ config, setConfig }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 space-y-4 bg-gray-50 border border-gray-200 rounded-lg shadow-md text-foreground">
      <div>
      ...
      <button type="submit" className="w-full bg-primary text-white py-2 px-4 rounded-md hover:bg-secondary transition-colors duration-200">
        Design My Forest
      </button>
    </form>
  );
